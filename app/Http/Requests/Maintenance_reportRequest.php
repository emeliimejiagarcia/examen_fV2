...
class Maintenance_reportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'equipment_condition' => 'required|string|min:20|max:255',
            'equipment_name' => 'required|string|min:5|max:255',
            'maintenance_date' => 'required|date',
            'maintenance_type' => 'required|string|min:10|max:255',
            'technician_name' => 'required|string|min:5|max:255',
            'maintenance_cost' => 'required|decimal|min:0',
            'report_status' => 'required|string|min:10|max:255',
    ...
    public function messages()
    {
        return[
            ...
            'equipment_condition.min' => 'La condición del equipo debe tener al menos 20 cáracteres.',
            ...
            'maintenance_type.min' => 'El tipo de mantenimiento debe tener al menos 10 cáracteres.',
            ...
            'report_status.min' => 'El estado del reporte debe tener al menos 10 cáracteres.',
